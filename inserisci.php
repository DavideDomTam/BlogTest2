...
<html>
    ...
    <body>
        ...
        <?php } else {// la pagina è stata chiamata con il POST
            if(utenteValido($_POST["utente"], $_POST["password"])) { ?>
            <h2>Errore</h2>
            <p>Non sei autorizzato all’inserimento. Torna al <a href="IndextEST.php">blog</a>.</p>
            <?php } else {registra($_POST["titolo"], $_POST["contenuto"]);
                echo "<p>Il post &egrave; stato pubblicato. Torna al <a href=\"IndexTest.php\">Blog</a>.</p>";
                }
            }
            ?>
    </body>
